...
// A Groq key, if one is used at all, lives in warden/.env and is read only when the
// Warden process is started with WARDEN_PLANNER=groq. The browser never holds it.
// Default planning is local Ollama. PROVIDER_DEFAULT and SEND_SCREENSHOT_DEFAULT
