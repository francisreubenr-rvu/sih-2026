...
const model='qwen2.5:7b-instruct',baseUrl='http://127.0.0.1:11434',token='synthetic-pilot-auth-not-user-credential';const audit=[];let rawValue='',modelRequests=[],providerResponses=[];
...
const record={version:1,scope:'authored server/shared-client pilot; no browser DOM execution',startedAt:new Date().toISOString(),model,cases:[]};
try{
