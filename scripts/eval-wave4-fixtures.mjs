/**
 * Wave4: score expanded held-out synthetic PII/redaction/utility fixtures.
...
const fixturePath = join(root, 'Benchmarks/datasets/wave4-heldout-pii-fixtures.json');
const argv = process.argv.slice(2);
const jsonFlag = argv.indexOf('--json');
const jsonOut = jsonFlag >= 0
  ? argv[jsonFlag + 1]
  : join(root, 'Benchmarks/results/wave4-pii-redaction-utility-v01.json');
...
const summary = {
  name: 'wave4-pii-redaction-utility',
  version: 'v01',
  ...
  official_score: null,
  scoreReason: 'Wave4 expanded held-out synthetic fixtures (12 cases). Not WebPII re-score; not organizer saturation. Official score null. Latency gate remains fail.',
  cases,
  notes: [
