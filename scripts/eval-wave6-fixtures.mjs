/**
 * Wave6: score expanded held-out synthetic PII/redaction/utility fixtures.
...
const jsonOut = jsonFlag >= 0
  ? argv[jsonFlag + 1]
  : join(root, 'Benchmarks/results/wave6-pii-redaction-utility-v01.json');
...
const summary = {
  name: 'wave6-pii-redaction-utility',
  version: 'v01',
  ...
  official_score: null,
  scoreReason: 'Wave6 expanded held-out synthetic fixtures (24 cases). Not WebPII re-score; not organizer saturation. Official score null. Latency gate remains fail.',
  cases,
  notes: [
